...
public class CrownEagle implements Piece {

	private final PieceType TYPE = PieceType.CROWN_EAGLE;
	...
	private String skill = "Geothermal Wind";
	...
	public ArrayList<Tile> getPossibleMoves(Tile selectedTile) {
		...
		// we assume that all is normal neutral
